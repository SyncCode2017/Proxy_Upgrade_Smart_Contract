...
import eth_utils  # make sure you run "pip install eth_utils"
...
def upgrade(
    ...
    *args
    ...
    # *args tells python to store any number of intergers that is passed to the fn in that position as args
